# Yash Mardikar &ndash; Portfolio

This repository hosts a single-page portfolio website suitable for deployment on GitHub Pages.

## Local development

Open `index.html` in your browser to preview the site locally. All assets are self-contained except for the hosted Google Font and hero background image.
